	...
	getCompaction: function(mode, code, addmode) {
		...
		switch(mode) {
			case 900: { // Text Compaction mode latch
					...
					if ((k = this._array_search(chval, this.textsubmodes[submode])) !== false) {
						...
						for (var s = 0; s < 4; ++s) {
							...
							if ((s != submode) && ((k = this._array_search(chval, this.textsubmodes[s])) !== false)) {
								...
								// } else if (code[0] == 'Z' && code[1] == 'O') {
								// 	if (''+submode+s == '13') {
								// 		txtarr.push(29);
								// 		submode = s;
								// 	} else if (''+submode+s == '30' && i < 26) {
								// 		txtarr = txtarr.concat([29]);
								// 		submode = s;
								// 	} else if (''+submode+s == '30' && i > 40) {
								// 		txtarr.push(28);
								// 		submode = s;
								// 	} else {
								// 		// latch
								// 		console.log(''+submode+s);
				...
				if (code[0] == 'Z' && code[1] == 'O') {
					let _l = '';
					// let _txtarr = [ '25', '14', '25', '14','0', '13', 29, '15','25','14', '1', '13', 29, '15','25','14',	'2', '14', 27, '17', '8', '6', '8', '13', '0', '11',    29, '15',   27, '25',   27, '14',  27, '3', 29, '15',  27,'25',   27, '14', 27,      '4', 28, '1', '4', '3', '1', 29, '15', 29, '25', '14', '5', 28, '5', '5', 29, '15', 28, '25','14', '6', 28, '4', '6', '17', '5', '0', 29, '15', 28, '25','14', '7', 29, '15','25','14', '8', '13', 29, '15','25','14', '9', '13' ]
					// console.log('');
					// for (let c of _txtarr)
					//     _l += c + ','
					// console.log(_l);

					// let _patch = _l.replace('29,25,14,3,', '27,25,27,14,27,3,');
					// txtarr = _patch.split(',');
					// txtarr.pop();
					_l = '';
					for (let c of txtarr)
					...
					let _patch = _l.replace(',28,25,15,29,25,14,3,', ',29,15,27,25,27,14,27,3,');
					_patch = _patch.replace(',29,15,25,14,4,', ',29,15,27,25,27,14,27,4,');
					_patch = _patch.replace(',25,15,29,25,14,5,', ',29,15,28,25,14,5,');
					_patch = _patch.replace(',25,15,29,25,14,6,', ',29,15,29,25,14,6,');
					_patch = _patch.replace(',25,15,29,25,14,6,', ',29,15,29,25,14,6,');
					_patch = _patch.replace(',29,15,29,25,14,6,', ',29,15,28,25,14,6,');
					_patch = _patch.replace(',25,15,29,25,14,7,', ',29,15,28,25,14,7,');
					txtarr = _patch.split(',');
					txtarr.pop();
					// console.log(_l);
				} else {
					for (let i = 3; i < txtarr.length; i++) {
						if (txtarr[i-2] == 25 && txtarr[i] == 29) {
							txtarr[i-2] = 29;
							txtarr[i] = 28;
						}
